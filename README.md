...
* [Contentful](https://contentful.com/) - CMS as API.
* [Tipe](https://tipe.io/) - Open source headless CMS.
* [ElegantCMS](https://www.elegantcms.io/) - Headless CMS builder.
* [Hexo](https://github.com/hexojs/hexo) - Static markdown website / blog generator, command line management and deployment.
...
* [PacketTotal](https://packettotal.com/api.html) - PCAP analysis As a Service
...
* [CatAAS](https://cataas.com/) - Cat images As a Service
...
* [Blockchain.com](https://api.blockchain.com/v3/) - API for tracking blockchain addresses, blocks, transactions and prices, for many cryptocurrencies.
