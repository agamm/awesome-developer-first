...
* [OGPeek](https://todd-agent-prod.web.app) - Dynamic Open Graph image generation API. Pass title/template/theme parameters, get a PNG back.
...
* [CronPeek](https://cronpeek.web.app) - Cron job monitoring with dead man's switch pattern. Flat-rate pricing.
