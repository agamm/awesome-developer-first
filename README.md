...
* [MCP Billing Gateway](https://github.com/sapph1re/mcp-billing-gateway-sdk) - API-first billing infrastructure for MCP server operators. Register servers, create pricing plans, verify x402 micropayments, and manage Stripe Connect payouts without building your own payment stack.
