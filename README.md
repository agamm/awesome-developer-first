...
* [Cyclic.sh](https://www.cyclic.sh/) - A DevOps platform designed for building platforms, and is an alternative to Kubernetes. It natively supports container orchestration, monitoring, load-balancing, and more across multi-cloud and on-prem infrastructure.
* [Cycle.io](https://www.cycle.io/) - Full stack app hosting (including dynamo db and s3).
